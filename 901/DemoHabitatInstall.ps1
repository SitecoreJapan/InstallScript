# パラメーターの設定
$prefix = "habitat.dev.local"
$PSScriptRoot = "C:\Projects\sif"
$XConnectCollectionService = "habitat_xconnect.dev.local"
$sitecoreSiteName = "habitat.dev.local"
...
$xconnectHostName = "habitat_xconnect.dev.local"
$sitecoreParams = @{
