...
param(
    ...
    [string]$CommerceServicesHostPostfix = "sc9.com",
...
if ($SkipDeployStorefrontPackages) {
    ...
    "SXAStorefrontPostInstallationSteps_MergeWebConfig" | ForEach-Object { $Skip += $_.Trim() }
}
...
$deployCommerceParams = @{
    ...
    RedisInstallationPath                    = Resolve-ItemPath -Path $RedisInstallationPath
